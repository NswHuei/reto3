...
![imagen de configuración del router vodafone5](imagen/vodafone5.jpg)
Nos proporciona dos tipo de filtro que pueden gestionar hasta 32 macs. Uno permite el acceso al red solamente los que están en la lista (conectado con WIFI) o no permite el acceso al red los equipos cuyo mac que están en la lista. Con el butón + podemos añadir al lista los equipos conectado al red.
